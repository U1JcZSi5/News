...
<div class="input-wrapper w3-mobile">
    ...
    <form id="inputForm" class="w3-container w3-white w3-round-xlarge" action="" method="POST">
        ...
        <input class="w3-input w3-border w3-margin-bottom" type="text" name="username" value="<?php echo $this->data['username'] ?>">

        <label class="w3-text-blue"><b>Password</b></label>
        <input class="w3-input w3-border w3-margin-bottom" type="password" name="password">

        <label class="w3-text-blue"><b>Email</b></label>
        <input class="w3-input w3-border" type="email" name="email" value="<?php echo $this->data['email'] ?>">
