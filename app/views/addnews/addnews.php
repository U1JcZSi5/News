...
<div class="input-wrapper w3-mobile">
    ...
    <form id="inputForm" class="w3-container w3-white w3-round-xlarge" action="" method="POST" enctype="multipart/form-data">

        <label class="w3-text-blue"><b>Author</b></label>
        <input class="w3-input w3-border w3-margin-bottom" type="text" name="author" value="<?php echo $this->data['author'] ?>">

        <label class="w3-text-blue"><b>Title</b></label>
        <input class="w3-input w3-border w3-margin-bottom" type="text" name="title" value="<?php echo $this->data['title'] ?>">

        <label class="w3-text-blue"><b>Content</b></label>
        <textarea class="w3-input  w3-border w3-margin-bottom" name="text" placeholder="Type here..."><?php echo $this->data['text'] ?></textarea>
